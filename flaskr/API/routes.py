...
def create_user():
    ...
    if key == "mJHZZzmrKm%TpvN95n27hvb4kjnQ5HP":
        ...
        new_user = User(user_associated_guild=guild_id, user_id=user_id, user_name=user_name,
...
def get_property_value():
    ...
    if key == "mJHZZzmrKm%TpvN95n27hvb4kjnQ5HP":
        ...
        return_json = {'response': 200, 'id': property.id, 'property_value': property.property_value}
        return jsonify(return_json)
    else:
        return_json = {'response': 401}
        return jsonify(return_json)
